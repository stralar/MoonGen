...
moonGenMainCommand="cd MoonGen/MoonGen; sudo ./build/MoonGen $moonGenScript -d $srcInterface $destInterface -r 40 38 -l 30 10 -q 350 1100 --short_DRX_cycle_length 8 --long_DRX_cycle_length 12 --active_time 1"
